...
clear all
use "~/Documents/GitHub/spreading_the_word/data_adjusted.dta", clear 
...
******************************************************
** Difference in means between HHS 
******************************************************
...
// Treated (both groups) versus control group
eststo clear
estpost ttest cons201701 cons201702 cons201703 cons201704 cons201705 ///
...
cd "/Users/mrfreerider/Documents/Research/Spreading the word/Results/tabs and graphs"

*******************************************
* Initial Analysis
*******************************************
** Descriptive stats and differences in means by treatment status. I compare averag consumptio before and after the intervention and their change.

do "summary_statistics.do"

** Graphs. Here I include figures of average consumption over time, by villages, by treatment groups.
